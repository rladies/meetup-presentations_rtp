...
This R Markdown file contains R code you can use to complete the exercises from the Introduction to R Markdown workshop. To see the output simply click on *Knit HTML* above. This might prompt you to 
...
working directory (where this R Markdown file is located). Also note that this is provided 
...
# Add your code for Mexico and the US here.
